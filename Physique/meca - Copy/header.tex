...
\declaretheorem[style=thmgreenbox, name=Définition, numberwithin=section]{definition}
\declaretheorem[style=thmgreen2box, name=Définition, numbered=no]{definition*}
\declaretheorem[style=thmredbox, name=Théorème, numberwithin=section]{theorem}
\declaretheorem[style=thmred2box, name=Théorème, numbered=no]{theorem*}
\declaretheorem[style=thmredbox, name=Lemme, numberwithin=section]{lemma}
\declaretheorem[style=thmredbox, name=Proposition, numberwithin=section]{proposition}
\declaretheorem[style=thmredbox, name=Corollaire, numberwithin=section]{corollary}
\declaretheorem[style=thmpinkbox, name=Problème, numberwithin=section]{problem}
\declaretheorem[style=thmpinkbox, name=Problème, numbered=no]{problem*}
\declaretheorem[style=thmblue2box, name=Affirmation, numbered=no]{claim}
